...
# Configuration
start_state_dataset = '/data/scratch/ec23984/cobot_data/train_start_sequences'
stop_state_dataset = '/data/scratch/ec23984/cobot_data/train_stop_sequences'
batch_size = 8
...
class CobotDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        frames = [self.transform(Image.open(frame).convert('RGB')) for frame in frame_paths[:num_segments]]
