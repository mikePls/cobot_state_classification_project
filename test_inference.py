...
# Configuration
model_path = './experiments/cobot_tsm_model.pth'  # Path to the saved model
...
# Example input: Replace with actual sequence directory
...
with torch.no_grad():
    ...
    print(f"Predicted Class: {predicted.item()}")  # Output the predicted class (0 for stop, 1 for start)
